...
def build_parser() -> argparse.ArgumentParser:
    ...
    _subcommand(sub, "graph-reconcile", mutate=True)
    ...
    judge_result = judge.add_mutually_exclusive_group(required=True)
    judge_result.add_argument("--result")
    judge_result.add_argument("--result-file")
    judge_evidence = judge.add_mutually_exclusive_group(required=True)
